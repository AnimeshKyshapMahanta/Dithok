...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        img = Image.open(r"C:\Users\hp\Desktop\Client\logo.png")
...
class ThirdPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def check():
            ...
            cursor.execute('SELECT DISTINCT SrNo FROM demo INNER JOIN anvesaktb USING(SrNo)')
            ...
            for row in results:
                lst = row[0]
                cursor.execute('select * from anvesaktb where SrNo = %s',(lst,))
